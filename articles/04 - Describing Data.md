...
Today, we'll cover de-serialization, the process of taking data from somewhere and making it useful for your program. If you prefer to skip to the end, go to the [All The Code In This Chapter](#all-the-code-from-this-chapter) section.
